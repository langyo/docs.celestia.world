...
Le Concédant vous accorde par la présente le droit de copier, modifier, créer des
œuvres dérivées, redistribuer et faire un usage non productif de l'Œuvre sous
Licence. Le Concédant accorde un Octroi d'Utilisation Supplémentaire, ci-dessus,
autorisant un usage productif limité tel que spécifié dans cet Octroi.

Si votre utilisation de l'Œuvre sous Licence n'est pas conforme aux exigences
actuellement en vigueur telles que décrites dans la présente Licence, vous devez
acheter une licence commerciale auprès du Concédant, de ses entités affiliées ou
de revendeurs agréés, ou vous abstenir d'utiliser l'Œuvre sous Licence.

Toutes les copies de l'Œuvre sous Licence originale et modifiée, ainsi que les
œuvres dérivées de l'Œuvre sous Licence, sont soumises à la présente Licence.
Cette Licence s'applique séparément pour chaque version de l'Œuvre sous Licence
publiée par le Concédant.

Vous devez afficher visiblement cette Licence sur chaque copie originale ou
modifiée de l'Œuvre sous Licence. Si vous recevez l'Œuvre sous Licence sous
forme originale ou modifiée d'un tiers, les termes et conditions énoncés dans
la présente Licence s'appliquent à votre utilisation de cette œuvre.

Toute utilisation de l'Œuvre sous Licence en violation de la présente Licence
mettra fin automatiquement à vos droits en vertu de la présente Licence pour la
version actuelle et toutes les autres versions de l'Œuvre sous Licence.

La présente Licence ne vous accorde aucun droit sur toute marque commerciale ou
logo du Concédant ou de ses affiliés (étant entendu que vous pouvez utiliser une
marque commerciale ou un logo du Concédant comme expressément requis par la
présente Licence).

DANS LA MESURE PERMISE PAR LA LOI APPLICABLE, L'ŒUVRE SOUS LICENCE EST FOURNIE
« EN L'ÉTAT ». LE CONCÉDANT DÉCLINE PAR LA PRÉSENTE TOUTE GARANTIE ET CONDITION,
EXPRESSE OU IMPLICITE, Y COMPRIS (SANS LIMITATION) LES GARANTIES DE QUALITÉ
...
Ce logiciel est protégé par des droits d'auteur de logiciel enregistrés
et des droits de brevet applicables détenus par le Concédant. Toute utilisation
commerciale non autorisée, revente, redistribution ou toute activité interdite
par la présente Licence peut donner lieu à des poursuites judiciaires en vertu
des lois applicables en matière de propriété intellectuelle, de droit des contrats
et de concurrence déloyale.

Pour toute demande de licence commerciale, veuillez contacter le Concédant.

-----------------------------------------------------------------------------

Note sur la traduction

Ceci est une traduction de commodité sans valeur juridique. La version
autoritaire est uniquement le fichier LICENSE en anglais, y compris sa section
"Rationale — Why this license". En cas de conflit, la version anglaise prévaut.
