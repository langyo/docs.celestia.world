...
Der Lizenzgeber gewährt Ihnen hiermit das Recht, das lizenzierte Werk zu kopieren,
zu ändern, abgeleitete Werke zu erstellen, weiterzuverteilen und nicht-produktiv zu
nutzen. Der Lizenzgeber erteilt eine zusätzliche Nutzungsberechtigung, die oben eine
begrenzte produktive Nutzung zulässt.

Wenn Ihre Nutzung des lizenzierten Werks nicht den aktuell geltenden Anforderungen
entspricht, die in dieser Lizenz beschrieben sind, müssen Sie eine kommerzielle Lizenz
vom Lizenzgeber, seinen verbundenen Unternehmen oder autorisierten Wiederverkäufern
erwerben oder die Nutzung des lizenzierten Werks einstellen.

Alle Kopien des originalen und geänderten lizenzierten Werks sowie abgeleitete Werke
unterliegen dieser Lizenz. Diese Lizenz gilt separat für jede Version des lizenzierten
Werks, die vom Lizenzgeber veröffentlicht wird.

Sie müssen diese Lizenz auf jeder Original- oder geänderten Kopie des lizenzierten
Werks deutlich sichtbar anzeigen. Wenn Sie das lizenzierte Werk in Original- oder
geänderter Form von einem Dritten erhalten, gelten die in dieser Lizenz festgelegten
Bedingungen für Ihre Nutzung dieses Werks.

Jede Nutzung des lizenzierten Werks unter Verletzung dieser Lizenz beendet automatisch
Ihre Rechte unter dieser Lizenz für die aktuelle und alle anderen Versionen des
lizenzierten Werks.

Diese Lizenz gewährt Ihnen keine Rechte an Marken oder Logos des Lizenzgebers oder
seiner verbundenen Unternehmen (sofern Sie eine Marke oder ein Logo des Lizenzgebers
verwenden dürfen, wie in dieser Lizenz ausdrücklich vorgeschrieben).

IM RAHMEN DES GELTENDEN RECHTS WIRD DAS LIZENZIERTE WERK "WIE BESEHEN" BEREITGESTELLT.
DER LIZENZGEBER LEHNT HIERMIT ALLE GEWÄHRLEISTUNGEN UND BEDINGUNGEN AB, AUSDRÜCKLICH
...
Diese Software ist durch eingetragene Software-Urheberrechte und geltende
Patentrechte geschützt, die beim Lizenzgeber liegen. Nicht autorisierte kommerzielle
Nutzung, Weiterverkauf, Weiterverbreitung oder jede unter dieser Lizenz verbotene
Aktivität kann rechtliche Schritte nach geltendem geistigem Eigentum, Vertragsrecht
und Wettbewerbsrecht nach sich ziehen.

Für kommerzielle Lizenzanfragen wenden Sie sich bitte an den Lizenzgeber.

-----------------------------------------------------------------------------

Hinweis zur Übersetzung

Dies ist eine nicht rechtsverbindliche Komfortübersetzung. Maßgeblich ist
ausschließlich die englische Datei LICENSE, einschließlich ihres Abschnitts
„Rationale — Why this license". Im Konfliktfall gilt die englische Fassung.
