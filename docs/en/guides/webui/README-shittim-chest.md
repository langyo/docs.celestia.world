...
**User-facing shell for the entelecheia multi-agent platform**
...
Webui, backend, and CLI for entelecheia: chat, admin panel, auth, multi-channel integrations, and device management.
