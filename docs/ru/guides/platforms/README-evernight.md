...
Трансляция экрана, SSH/VNC/RDP, телеметрия оборудования, промышленные протоколы (Modbus/S7comm/OPC UA/CAN/EtherCAT) и оркестрация контейнеров/виртуальных машин.
